...
class testmodel(nn.Module):
    def __init__(self, num_classes_list, model_name, projector_features = None, use_mlp=False, pretrained = True, *args, **kwargs):
...
def build_omni_model_from_checkpoint(args, num_classes_list, key):
    if args.model_name == "swin_base": #swin_base_patch4_window7_224
        ...
        model = testmodel(num_classes_list, model_name="swinv2_base_window12_192",projector_features=args.projector_features, use_mlp=args.use_mlp)
...
def build_omni_model(args, num_classes_list):
    if args.model_name == "swin_base": #swin_base_patch4_window7_224
        ...
        # BASE_CLASS = swinv2.SwinTransformerV2
        model = testmodel(num_classes_list, model_name="swinv2_base_window8_256",projector_features=args.projector_features, use_mlp=args.use_mlp)
    if "swinv2" not in args.model_name  and args.pretrained_weights is not None:
